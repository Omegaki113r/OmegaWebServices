 ...
 * -----
 * Last Modified: Tuesday, 11th February 2025 2:39:23 pm
    ...
    namespace WebServices
    {
        namespace WebSocket
        {
            namespace Client
            {
                ...
                WSConnection Init(const char *in_url);
                WSConnection Init(const char *in_url, const Authentication &in_auth);
